...
const _SERVE_KWARGS_TYPE = NamedTuple{
    (
        :name, :session_id, :force, :tools, :namespace, :allow_mirror,
        :allow_restart, :spawned_by, :on_shutdown, :infiltrator, :mode, :host,
        :port, :stream_port, :curve, :server_secret, :allow_any,
        :allowed_clients, :discoverable,
    ),
    Tuple{
        String, Nothing, Bool, Vector{GateTool}, String, Bool, Bool, String,
        Nothing, Bool, Symbol, String, Int, Int, Bool, Nothing, Bool,
        Vector{String}, Bool,
    },
}
